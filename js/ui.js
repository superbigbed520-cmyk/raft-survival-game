...
export class UIManager {
    ...
    render(ctx, player, dayNight, canvasWidth, canvasHeight) {
        ...
        // 操作提示
        ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
        ctx.fillRect(10, canvasHeight - 115, 380, 70);
        ctx.fillStyle = '#fff';
        ctx.font = '11px Arial';
        ctx.textAlign = 'left';
        ctx.fillText('AD: 移动 | W/空格: 跳跃 | F: 钓鱼 | E: 工作台', 20, canvasHeight - 95);
        ctx.fillText('TAB: 背包 | B: 建造 | 1-6: 切换物品 | 点击: 拾取', 20, canvasHeight - 78);
        ctx.fillText('Q: 使用物品 (食物/水) | ESC: 关闭界面', 20, canvasHeight - 61);
